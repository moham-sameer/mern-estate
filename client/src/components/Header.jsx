...
const Header = () => {
  ...
  return (
    ...
    <Link to='/'>
      ...
      <Link to='/'>
        <li className='hidden sm:inline cursor-pointer text-slate-700 hover:underline'>Home</li>
      </Link>
        <Link to='/about'>
        ...
        {currentUser ? (<img className='rounded-full h-7 w-7 object-cover' src={currentUser.data.avatar} alt='profile'/>) :
